...
public class Table {
	private double dPot;
	private ArrayList<Card> board = new ArrayList<Card>();// create a board array
	private Deck deck;
	...
	public Table(int iPlayercount)
	{
		...
		dPot =0;
		deck = new Deck();// create adeck object
		deck.Shuffle();// shuffle the card
		
		for (int i = 0; i<iPlayercount; i++)// get number of players
		{
			Playerlist.add(new Player());// create the number of players
		}
	...
	public ArrayList<Card> getTable() {//get the 3 cards on the table 
		return board;
	}
	...
	public void GetScore(Player player){// Calculate the winner. Or conditions to win
	...
	private ArrayList<Integer> getNumber(ArrayList<Card> cards){
		ArrayList<Integer> NumberList = new ArrayList<Integer>();
		for (Card card : cards){
	...
	private ArrayList<Integer> getSuit (ArrayList<Card> cards){
		ArrayList<Integer> SuitList = new ArrayList<Integer>();
		for (Card card : cards){
